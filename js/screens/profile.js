...
(function (w) {
  ...
  function files() {
    return '<div style="display:flex;flex-direction:column;gap:14px">' +
      '<div style="display:flex;align-items:center;gap:12px;padding:18px;border:1px dashed ' + UI.color('--border-strong') + ';border-radius:10px;background:var(--bg);flex-wrap:wrap">' +
        icon('upload', 20) +
